...
/**
 @ingroup Chart
 @brief Protocol of chart view data source 

 This protocol defines methods and properties that needs to be implemented by a chart view data source. 
 */
...
/**	
 @brief Asks the data source to return the title of the chart view.
...
/**	
 @brief Asks the data source to return the chart type of the series at a specific index.
...
/**	
 @brief Asks the data source to return the number of categories in the chart view.  
...
/**	
 @brief Asks the data source to return the category at a specific index.
 
 In chart rendering, the description of the category object will be used as the display string for that category.
 @param chartView An object representing the chart view requesting this information.
...
/**	
 @brief Asks the data source to return the number of series in the chart view.
...
/** 
 @brief Asks the data source to return the series at a specific index.

 In chart rendering, the description of the series object will be used as the display string for that series.
 @param chartView An object representing the chart view requesting this information.
...
/**	
 @brief Ask the data source to return the value of the category and the series at their specific indices.
...
/**	
 @brief Asks the data source to return the number of dimensions of values in the chart view.  
...
/**	
 @brief Asks the data source to return the formatter for value at a specific dimension in the chart view.  

 This method is optional.  If it is not implemented, there will be no formatting on the value object. The string representation is that of [NSObject description]
 @param chartView An object representing the chart view requesting this information.
 @param valueDimensionIndex An index corresponding to a value in the value dimension in the chartView. In normal single-value-dimensional charts, valueIndex is usually equal to 0.
...
/**	
 @brief Asks the data source to return the formatter for categories in the chart view.  
 
 This method is optional.  If it is not implemented, there will be no formatting on the category object.
 @param chartView An object representing the chart view requesting this information.
 @returns The NSFormatter object.
 */
...
/**	
 @brief Asks the data source to return the formatter for series in the chart view.  
 
 This method is optional.  If it is not implemented, there will be no formatting on the series object.
 @param chartView An object representing the chart view requesting this information.
 @returns The NSFormatter object.
 */
...
/**	
 @brief Asks the data source to return the label for category in the chart view.  
 
 This method is optional. If it is not implemented, there will be no title.
 @param chartView An object representing the chart view requesting this information.
 @param categoryLevelIndex An index corresponding to a category level.
 @returns The label.
 */
...
/**	
 @brief Asks the data source to return the label for series in the chart view.  
...
/**	
 @brief Asks the data source to return the title for value at a specific dimension in the chart view.  
...
/**	
 @brief Asks the data source to return the number of layers of the chart view. 
...
/**
 @brief Asks the data source to return the index of the layer that the specific series belongs to.
...
/**	
 @brief Asks the data source to whether it provides data in the form of data items. 
	
 In some charts, such as scatter chart, it is more efficient to get data by data items instead of traverse through all the category and series combinations.
 In this case, an optional set of data source APIs are provided to get data in this way.  
 If getDataByDataItemsInChartView: is not implemented or returns NO, the default chartView:valueAtDimension:forCategoryAtIndex:andSeries: will be used to fetch data.
 @param chartView An object representing the chart view requesting this information.
...
/**
 @brief Asks the data source to return the number of data items in the chart view. 
...
/**	
 @brief Asks the data source to return the category index of a data item in the chart view. 
...
/**	
 @brief Asks the data source to return the series index of a data item in the chart view. 
...
/**	
 @brief Ask the data source to return the value of a data item at its specific index.
...
/**	
 @brief Asks the data source to return the number of category levels in the cateogry hierarchy of the chart view. 

 In some charts, categories may be grouped in hierarchy, i.e. with super-categories.
 ...
 The index of the first sub-category for the category at index 0 in level at index 1 is 0.
 The index of the last sub-category for the category at index 0 in level at index 1 is 2.
 The index of the first sub-category for the category at index 1 in level at index 1 is 3.
 The index of the last sub-category for the category at index 1 in level at index 1 is 5.
 @param chartView An object representing the chart view requesting this information.
...
/**
 @brief Asks the data source to return the index of the first category that belongs to the super category in a specific location in a  super category level of the chart view. 
...
/**	
 @brief Asks the data source to return the index of the last category that belongs to the super category in a specific location in a  super category level of the chart view. 
