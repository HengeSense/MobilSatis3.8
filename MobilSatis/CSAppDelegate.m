...
>>>>>>> aafa7e7853d79c1499a3bd8c1a7fe7c3b733daff
...
- (void)loginConfirmed:(CSUser *)user{
    
    self.splitViewController = [[UISplitViewController alloc]init];
    self.masterViewController = [[CSMasterViewController alloc] initWithUser:user];
	self.profileViewController = [[CSProfileViewController alloc] initWithUser:user];
    self.profileViewController.newVersion = self.newVersion;
    
    UINavigationController *detailNav = [[UINavigationController alloc]initWithRootViewController:self.profileViewController];
    UINavigationController *masterNav = [[UINavigationController alloc]initWithRootViewController:self.masterViewController];
    [[detailNav navigationBar] setTintColor:[UIColor blackColor]];
    [[masterNav navigationBar] setTintColor:[UIColor blackColor]];
