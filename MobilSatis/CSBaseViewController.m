...
- (void)playAnimationOnView:(UIView*)myView{
    ...
    if([UIDevice currentDevice].userInterfaceIdiom==UIUserInterfaceIdiomPad) {
        ...
        if ([currentVC.nibName isEqualToString:@"CSLoginViewController"] || [currentVC.nibName isEqualToString:@"CSLoginViewController_Ipad"] || [currentVC.nibName isEqualToString:@"CSRegisterUserViewController"] ) {
            animationView =
            [[UIImageView alloc] initWithFrame:CGRectMake(460, 320, 100, 100)];
        }else{
            animationView =
            [[UIImageView alloc] initWithFrame:CGRectMake(300, 320, 100, 100)];
        }
    } 
    else{
        animationView = 
