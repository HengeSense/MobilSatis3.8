...
- (id)initWithUser:(CSUser *)myUser
{
    ...
    {
        self = [super initWithNibName:@"CSDealerListViewController_Ipad" bundle:nil];
    }
...
-(void)initCustomerFromResponse:(NSString*)response {
    ...
    survey = [ABHXMLHelper getValuesWithTag:@"SURVEY" fromEnvelope:response];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
    {
        [[self navigationItem] setTitle:@"Bayi Seçimi"];
