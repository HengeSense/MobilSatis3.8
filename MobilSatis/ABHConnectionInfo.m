...
static NSString *systemNumber = @"01";
//static NSString *systemNumber = @"00";
NSString *userId = @"MOBIL";
NSString *password = @"12345678";
//NSString *userId = @"AKEREMB";
//NSString *password = @"1234567";


NSString *R3hostName = @"200.100.32.49";   // r3 canlı server
//49da var test-10.12.1.188  //qa -10.12.253.2
//NSString *R3hostName = @"10.12.253.2";  //r3 test server
NSString *R3client = @"330";
//NSString *R3destination = @"AGT330";
NSString *R3destination = @"AGP330";//agt330CLNT100
NSString *R3systemNumber = @"01"; // r3 canlı systemNumber
//NSString *R3systemNumber = @"00";   // r3 test systemNumber
//NSString *R3userId = @"AKEREMB";
//NSString *R3password = @"12345678";
