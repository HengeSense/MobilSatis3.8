...
+ (NSString*)correctNumberValueWithDecimal:(NSString*)numberValue{
    NSString *returnValue;
    ...
    {
        returnValue = [array objectAtIndex:0];
        decimalValue = [array objectAtIndex:1];
        
        NSNumberFormatter* numberFormatter = [[NSNumberFormatter alloc] init];
        [numberFormatter setFormatterBehavior: NSNumberFormatterBehavior10_4];
        [numberFormatter setNumberStyle: NSNumberFormatterDecimalStyle];
        returnValue = [numberFormatter stringFromNumber:[numberFormatter numberFromString:returnValue]];
        decimalValue = [numberFormatter stringFromNumber:[numberFormatter numberFromString:decimalValue]];
        
        finalValue = [NSString stringWithFormat:@"%@.%@",returnValue,decimalValue];
        // NSLog(@"%@",returnValue);
    }
    @catch (NSException *ex) {
